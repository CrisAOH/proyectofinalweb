...
<form method="POST" action="usuario_servidor.php?action=<?php echo $action; ?>">
  <div class="mb-3">
    ...
    <input type="text" name="data[usuario]" class="form-control" placeholder="Usuario"
      value="<?php echo isset($data[0]['usuario']) ? $data[0]['usuario'] : ''; ?>" required minlength="1" maxlength="100" />
  </div>
  <div class="mb-3">
    <label class="form-label">Contraseña</label>
    <input type="text" name="data[contrasena]" class="form-control" placeholder="Contraseña"
      value="<?php echo isset($data[0]['contrasena']) ? $data[0]['contrasena'] : ''; ?>" required minlength="1" maxlength="100" />
  </div>
  <div class="mb-3">
    <?php if ($action == 'edit'): ?>
