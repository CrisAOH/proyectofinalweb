    ...
    <form method="POST" action="equipo.php?action=<?php echo $action; ?>" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <input type="text" name="data[no_serie]" class="form-control" placeholder="No. Serie"
                value="<?php echo isset($data[0]['no_serie']) ? $data[0]['no_serie'] : ''; ?>" required minlength="1"
                maxlength="100" />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="data[otras_caract]" class="form-control" placeholder="Características adicionales"
