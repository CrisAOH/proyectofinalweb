        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 footer-contact">
                    ...
                    <p>
                        Portal Octavio Muñoz Ledo s/n <br>
                        Centro, 36700<br>
                        Salamanca, Gto. <br><br>
                        <strong>Phone:</strong> 464 641 4500<br>
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    <h4>Estética</h4>
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">No sirve</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">No sirve</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">No sirve</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">No sirve</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">No sirve</a></li>
                ...
                <div class="col-lg-4 col-md-6 footer-newsletter">
                    <h4>Estética</h4>
                    <p>No presione el botón, no sirve.</p>
