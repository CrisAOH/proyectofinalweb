    ...
    <form method="POST" action="servidor.php?action=<?php echo $action; ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="data[ip]" class="form-control" placeholder="IP"
                value="<?php echo isset($data[0]['ip']) ? $data[0]['ip'] : ''; ?>" required minlength="1"
                maxlength="100" />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="data[cant_procesadores]" class="form-control"
                placeholder="Cantidad de procesadores"
                value="<?php echo isset($data[0]['cant_procesadores']) ? $data[0]['cant_procesadores'] : ''; ?>"
        ...
        <div class="mb-3">
            ...
            <input type="text" name="data[mas_detalles]" class="form-control" placeholder="Otros detalles del servidor"
                value="<?php echo isset($data[0]['mas_detalles']) ? $data[0]['mas_detalles'] : ''; ?>" required
